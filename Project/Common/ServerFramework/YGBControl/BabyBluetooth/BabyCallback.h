...
//发现peripherals规则
@property (nonatomic, copy) BOOL (^filterOnDiscoverPeripherals)(CBPeripheral *peripheral, NSDictionary *advertisementData, NSNumber *RSSI);
//连接peripherals规则
@property (nonatomic, copy) BOOL (^filterOnconnectToPeripherals)(CBPeripheral *peripheral, NSDictionary *advertisementData, NSNumber *RSSI);
