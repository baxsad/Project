...
typedef NS_ENUM(NSInteger, UITableScenCellPosition) {
  UITableScenCellPositionNone = -1, // 初始化用
  UITableScenCellPositionFirstInSection,
  UITableScenCellPositionMiddleInSection,
  UITableScenCellPositionLastInSection,
  UITableScenCellPositionSingleInSection,
  UITableScenCellPositionNormal,
};
