...
- (void)didInitialized {
  ...
  self.imagePosition = UIButtonImagePositionLeft;
}
...
- (void)layoutSubviews {
  ...
  if (self.imagePosition == UIButtonImagePositionTop || self.imagePosition == UIButtonImagePositionBottom) {
    ...
    if (self.imagePosition == UIButtonImagePositionTop) {
  ...
  } else if (self.imagePosition == UIButtonImagePositionLeft || self.imagePosition == UIButtonImagePositionRight) {
    ...
    if (self.imagePosition == UIButtonImagePositionLeft) {
      switch (self.contentHorizontalAlignment) {
        case UIControlContentHorizontalAlignmentLeft:
          imageFrame = isImageViewShowing ? CGRectSetX(imageFrame, contentEdgeInsets.left + self.imageEdgeInsets.left) : imageFrame;
...
- (void)setImagePosition:(UIButtonImagePosition)imagePosition {
